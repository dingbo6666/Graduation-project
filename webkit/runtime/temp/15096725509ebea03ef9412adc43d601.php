<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\phpStudy\WWW\my project\webkit\public/../application/bis\view\deal\add.html";i:1514883473;s:83:"D:\phpStudy\WWW\my project\webkit\public/../application/bis\view\public\header.html";i:1514254062;s:83:"D:\phpStudy\WWW\my project\webkit\public/../application/bis\view\public\footer.html";i:1514254146;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
	...
	基本信息：
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="check-box">
				<?php if(is_array($bislocations) || $bislocations instanceof \think\Collection): $i = 0; $__LIST__ = $bislocations;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">折扣开始时间：</label>
			<div class="formControls col-xs-8 col-sm-3">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">折扣结束时间：</label>
			<div class="formControls col-xs-8 col-sm-3">
