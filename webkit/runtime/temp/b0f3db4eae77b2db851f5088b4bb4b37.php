<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\phpStudy\WWW\my project\webkit\public/../application/index\view\detail\index.html";i:1515814727;s:83:"D:\phpStudy\WWW\my project\webkit\public/../application/index\view\public\head.html";i:1515642971;s:82:"D:\phpStudy\WWW\my project\webkit\public/../application/index\view\public\nav.html";i:1515553822;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="nav-bar-header">
    <div class="nav-inner">
        <ul class="nav-list">
            ...
            <li class="nav-item"><a class="item">优惠</a></li>
    ...
    <div class="p-detail">
        <div class="p-bread-crumb">
            <div class="w-bread-crumb">
                <ul class="crumb-list">
                    <li class="crumb"><a>商品</a><span class="ico-gt">&gt;</span></li>
                            ...
                            <li class="item-bought">
                                <div class="sl-wrap">
                                    <div class="sl-wrap-cnt">
                                        <div class="item-bought-num"><span class="intro-strong">已售出<?php echo $deal->buy_count; ?></span>件</div>
                                    </div>
                                </div>
                            </li>
                        </ul>
                            ...
                            <div class="buy-panel">
                                <div class="validdate-buycount-area static-hook-real static-hook-id-11">
                                    ...
                                    <div class="item-buycount-row j-item-buycount-row">
                                        ...
                                        <div class="text-wrap">
                                            <span class="left-budget">库存剩余<?php echo $overplus; ?>份</span>
                                ...
                                <div class="item-buy-area">
                                    <div style="float:left" class="static-hook-real static-hook-id-12">
                                        <?php if($flag == 1): ?>
                                        <a  class="btn-buy btn-buy-qrnew j-btn-buy btn-hit" style="background: #C0C0C0;border-bottom:#C0C0C0; ">立即购买</a>
                                        <?php else: ?>
                                        <a href="" class="btn-buy btn-buy-qrnew j-btn-buy btn-hit">立即购买</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
