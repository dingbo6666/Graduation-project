<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\phpStudy\WWW\my project\webkit\public/../application/index\view\user\register.html";i:1515380692;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="wrapper">
        <div class="head">
            <ul>
                <li><a href="/"><img src="/static/index/image/logo.png" alt="logo"></a></li>
                <li class="divider"></li>
                <li><a href="/"></a></li>
            </ul>
        ...
        <div class="content">
            <form action="<?php echo url('user/register'); ?>" method="post">
                ...
                <p class="pass-form-item">
                    ...
                    <input type="text" name="email" class="pass-text-input" placeholder="可用于接受优惠券账号和密码便于消费">
                </p>
